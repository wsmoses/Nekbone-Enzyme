...
c     Sum overlap region (border excluded)
     ...
     $    mg_work(i),2,one,mg_work(i),0,one,enx,eny,enz)
      ...
      call h1mg_schwarz_toreg3d_acc(mg_work,mg_work(i),mg_nh(l))
      call h1mg_dssum(mg_work,l)                           ! sum border nodes
...
!$ACC UPDATE SELF(z,rhs)
      ...
      is    = 1                                       ! solve index
   !Schwarz
      call copy(rhs2,rhs,n)
      call copy(z2,z,n)
      call h1mg_schwarz_acc(z2,rhs2,sigma,l)                ! z := sigma W M       rhs
      call copy(r,rhs2,n)                              ! r  := rhs
...
!        OVERLAPPING Schwarz exchange and solve:
      ...
      call hsmg_coarse_solve_acc ( e(is) , r )            ! e  := A   r
...
c     call exitt
      ...
      do l = 2,mg_h1_lmax-1                           ! UNWIND.  No smoothing.
         ...
         is = is - n
         n  = mg_h1_n(l,mg_fld)
         call h1mg_intp_acc (w,e(im),l-1)                 ! w   :=  J e
         i1=is-1                                      !            l-1
         do i=1,n
            e(i1+i) = e(i1+i) + w(i)                  ! e   :=  e  + w
         enddo                                        !  l       l
...
c-----------------------------------------------------------------------
      subroutine h1mg_schwarz_wt3d_acc(e,wt,n)
      include 'SIZE'
      integer n
      real e(n,n,n,nelt)
      real wt(n,n,4,3,nelt)
